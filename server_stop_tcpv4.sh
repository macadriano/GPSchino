#!/bin/bash
# Script para detener el servidor TCP V4
# Uso: ./server_stop_tcpv4.sh
...
echo -e "${BLUE}🛑 DETENIENDO SERVIDOR TCP V4${NC}"
echo "=================================="
...
if [ -z "$REMAINING_PIDS" ]; then
    ...
    echo -e "   ${BLUE}🔄 Para reiniciar:${NC} ./server_start_tcpv4.sh"
else
