...
def get_log_filename():
    ...
    # Formato: LOG_ddmmyy (día, mes, año de 2 dígitos)
    nombre_log = f"LOG_{fecha_actual.day:02d}{fecha_actual.month:02d}{fecha_actual.year % 100:02d}"
    # Crear directorio logs si no existe
    if not os.path.exists("logs"):
        os.makedirs("logs")
    return os.path.join("logs", nombre_log)
